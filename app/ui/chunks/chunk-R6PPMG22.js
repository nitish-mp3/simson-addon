import{b as d,d as o}from"./chunk-XNCLTULO.js";import{c as x}from"./chunk-RP7N3B43.js";import{a as m,e,f as S,g as l,h as _}from"./chunk-6R6CGC23.js";import{a as r,b as w,c as k}from"./chunk-OPL7LVHU.js";var L={setup:()=>import("./setup-NIFYGTRF.js").then(t=>t.renderSetup),overview:()=>import("./overview-JRKOHU2G.js").then(t=>t.renderOverview),routing:()=>import("./routing-3WASTW7P.js").then(t=>t.renderRouting),sip:()=>import("./sip-2FF2CX6Q.js").then(t=>t.renderSip),media:()=>import("./studio-SZM4VKS4.js").then(t=>t.renderMediaStudio),automation:()=>import("./automation-E6OCNJ4U.js").then(t=>t.renderAutomation),advanced:()=>import("./advanced-DA2NWYVR.js").then(t=>t.renderAdvanced)},f=new Map,h=0;function H(){document.body.innerHTML=`
  ...
  `,A(),document.body.addEventListener("click",async a=>{let n=a.target.closest("[data-page]");if(n){if(e.page==="media"&&n.dataset.page!=="media"){let{stopMediaPreview:i}=await import("./studio-SZM4VKS4.js");i(!1)}e.page=n.dataset.page,e.navOpen=!1,p();return}if(a.target.closest("[data-action]"))try{let{onClick:i}=await import("./clicks-TYJNQOMT.js");await i(a)}catch(i){d(i.message,"bad")}});let t=async a=>{try{let{onInput:n}=await import("./inputs-MO2A3TIQ.js");n(a)}catch(n){d(n.message,"bad")}};document.body.addEventListener("input",t),document.body.addEventListener("change",t)}function A(){r("nav").innerHTML=l.map(([a,n,i])=>`
